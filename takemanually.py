    ...
    def fill_attendance():
        ...
        if subb == "":
            ...
            def create_csv():
                df = pd.DataFrame(d)
                csv_name = (
                    "E:\\5th Semester\\AI Theory\\project\\github repos\\Attendance-Management-system-using-face-recognition\\Attendance(Manually)\\"
                    + subb
                    + "_"
                    + Date
                    + "_"
            ...
            def attf():
                ...
                subprocess.Popen(
                    r'explorer /select,"E:/5th Semester/AI Theory/project/github repos/Attendance-Management-system-using-face-recognition/Attendance(Manually)"'
                )
